---
title: API d'analyse de fichiers Publisher pour C++
weight: 50
url: /fr/cpp/ 
description: Solution API de manipulation de fichiers PUB. Bibliothèque C++ pour analyser, traiter et convertir les formats de documents MS Publisher en PDF. 
metakeywords: Java pour c++, solution cpp PUB, Java cpp, bibliothèque pub c++
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API C++ pour analyser les fichiers de l'éditeur" h2="Manipulez les fichiers Publisher et convertissez le format PUB en PDF dans n'importe quelle application basée sur C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
 Aspose.PUB pour C++ est une bibliothèque de traitement des formats Microsoft PUb. Il permet aux développeurs de lire et de charger des fichiers PUB, de manipuler des métadonnées ainsi que de convertir le format de fichier de publication électronique (.pub) en PDF. Il offre une conversion rapide et fiable de PUB en PDF, HTML, XLSX, DOC et les formats d'image les plus populaires. La fonctionnalité est également implémentée dans des applications multiplateformes gratuites afin que vous puissiez l'essayer vous-même dès maintenant.
</p>
...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu de Aspose.PUB pour l'API C++." >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de traitement .NET PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="La bibliothèque prend entièrement en charge les applications C++ développées sur la plate-forme Windows et Linux ayant [Configuration requise](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulation PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.PUB pour C++ prend en charge Publisher [format de fichier](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Convertir des documents PUB en PDF
    </p>
   </div>
   <!--
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     La bibliothèque Aspose.PUB pour C++ peut lire et convertir des documents de publication (.pub) au format PDF, avec seulement quelques lignes de code.
    </p>
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="Références API" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.PUB pour C++ ?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB propose des API de traitement PUB individuelles pour d'autres environnements de développement populaires, comme indiqué ci-dessous :" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/fr/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
