---
title: API de manipulation de fichiers C# .NET PUB
weight: 20
url: /fr/net/ 
description: API C# ASP.NET VB.NET Publisher pour analyser, traiter et convertir les fichiers MS Publisher. Convertir PUB en PDF, Word, Excel et images.
metakeywords: C# pour PUB, Csharp pour PUB, C# PUb, pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API .NET pour manipuler les fichiers de l'éditeur" h2="Convertir le format PUB Publisher en PDF sans aucune dépendance logicielle." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://releases.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu de Aspose.PUB pour l'API .NET." >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de traitement .NET PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="Aspose.PUB pour .NET prend en charge toutes les principales plates-formes, y compris." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulation PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.PUB pour .NET prend en charge Publisher [format de fichier](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Références API" href="https://reference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.PUB pour .NET ?" tabId="success-stories" >}}
