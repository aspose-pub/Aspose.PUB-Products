---
title: Java 的發布者文件解析 API
weight: 40
url: /zh-hant/java/ 
description: 用於解析、處理和將 Publisher 文檔格式轉換為 PDF 的 Java 庫。將功能實現到您自己的產品中.
metakeywords: Java for PUB, Java PUB 解決方案, Java PUb, pub Java 庫
---
...
<p>
 Aspose.PUB for Java 是一個靈活且易於使用的庫來處理電子出版物文件。它支持將流行的電子出版物文件格式 (.pub) 加載和轉換為 PDF。它提供 PUB 到 PDF、HTML、XLSX、DOC 和最流行的圖像格式的快速可靠的轉換。該功能也在免費的跨平台應用程序中實現，因此您現在可以自己嘗試。
</p>
...
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <!--<header><i class="fa fa-bars"> </i>特徵</header>
...
<li>轉換</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java PUB 處理 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.PUB for Java API 完全支持基於 GUI 的桌面、Web 和控制台應用程序。" >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<h2 class="h2title">Latest PUB API 特徵</h2>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for Java 可以讀取發布文件 (.pub) 並將其轉換為 PDF 文件，只需幾行代碼。
    </p>
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼選擇 Aspose.PUB for Java？" tabId="success-stories" >}}
