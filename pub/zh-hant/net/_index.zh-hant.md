---
title: C# .NET PUB 文件操作 API
weight: 20
url: /zh-hant/net/ 
description: C# ASP.NET VB.NET Publisher API 用於解析、處理和轉換 MS Publisher 文件。將 PUB 轉換為 PDF、Word、Excel 和圖像.
metakeywords: 用於 PUB 的 C#、用於 PUB 的 Csharp、C# PUB、pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API 來操作發布者文件" h2="將 PUB Publisher 格式轉換為 PDF，無需任何軟件依賴." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
MS Publisher 是一個用於創建專注於處理頁面佈局信息的文檔的程序。該程序打開下一個文件格式 MS Publisher 2.0 或更高版本、擴展名為 .txt 的文件、RTF 文件、MS Word 文件、HTML 文件、Unicode 文本等等。該軟件允許創建您自己設計的文檔或為您的文檔使用格式化的設計。
MS Publisher 以 .pub 擴展名保存文件，除了 Publisher 之外，沒有多少應用程序可以處理此類文件。 
</p>
<p>
Aspose.PUB for .NET 是一個靈活且易於使用的庫，用於處理電子出版物文件。它支持將流行的電子出版物文件格式 (.pub) 加載和轉換為 PDF。它提供 PUB 到 PDF、HTML、XLSX、DOC 和最流行的圖像格式的快速可靠的轉換。該功能也在免費的跨平台應用程序中實現，因此您現在可以自己嘗試。
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.PUB for .NET API 概述。" >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET PUB 處理 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.PUB for .NET 支持所有主要平台，包括." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB 操作 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.PUB for .NET 支持 Publisher [文件格式](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for .NET 可以讀取發布文件 (.pub) 並將其轉換為 PDF 文件，只需幾行代碼.
    </p>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/pub/net/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API 參考" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼 Aspose.PUB 用於 .NET？" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB 為其他流行的開發環境提供單獨的 PUB 處理 API，如下所列：" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/zh-hant/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
    {{< blocks/products/pf/offers-section-item link="/pub/zh-hant/cpp/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg" sdkName="C++" >}}
