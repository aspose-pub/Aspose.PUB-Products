---
title: C++ 的發布者文件解析 API
weight: 50
url: /zh-hant/cpp/ 
description: PUB 文件操作 API 解決方案。用於解析、處理 MS Publisher 文檔格式並將其轉換為 PDF 的 C++ 庫. 
metakeywords: Java for c++, cpp PUB 解決方案, Java cpp, pub c++ 庫
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用於解析發布者文件的 C++ API" h2="在任何基於 C++ 的應用程序中操作 Publisher 文件以及將 PUB 格式轉換為 PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://releases.aspose.com/pub/cpp//" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
 Aspose.PUB for C++ 是一個 Microsoft PUB 格式處理庫。它允許開發人員讀取和加載 PUB 文件、處理元數據以及將電子出版物文件格式 (.pub) 轉換為 PDF。它提供 PUB 到 PDF、HTML、XLSX、DOC 和最流行的圖像格式的快速可靠的轉換。該功能也在免費的跨平台應用程序中實現，因此您現在可以自己嘗試。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.PUB for C++ API 概述。" >}}
...
<li>轉換</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET PUB 處理 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="該庫完全支持在 Windows 和 Linux 平台上開發的 C++ 應用程序，具有 [系統要求](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for C++ 庫可以讀取發布文檔 (.pub) 並將其轉換為 PDF 格式，只需幾行代碼.
    </p>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="API 參考" href="https://reference.aspose.com/pub/cpp/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼 Aspose.PUB 用於 C++？" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB 為其他流行的開發環境提供單獨的 PUB 處理 API，如下所示：" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/zh-hant/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg" sdkName=".NET" >}}
