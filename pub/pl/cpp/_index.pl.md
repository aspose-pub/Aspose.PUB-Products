---
title: API do analizowania plików wydawców dla C++
weight: 50
url: /pl/cpp/ 
description: Rozwiązanie API do manipulacji plikami PUB. Biblioteka C++ do analizowania, przetwarzania i konwertowania formatów dokumentów MS Publisher do formatu PDF. 
metakeywords: Java dla c++, rozwiązanie cpp PUB, Java cpp, biblioteka pub c++
---
...
<p>
 Aspose.PUB dla C++ to biblioteka przetwarzania formatów Microsoft PUb. Pozwala programistom odczytywać i ładować pliki PUB, manipulować metadanymi, a także konwertować format pliku publikacji elektronicznych (.pub) do formatu PDF. Oferuje szybką i niezawodną konwersję PUB do PDF, HTML, XLSX, DOC i najpopularniejszych formatów graficznych. Funkcjonalność jest również zaimplementowana w darmowych aplikacjach wieloplatformowych, więc możesz wypróbować ją już teraz.
</p>
...
{{< blocks/products/pf/carousel-item h3="W skrócie" description="Omówienie Aspose.PUB dla C++ API." >}}
...
<li>Konwersja</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Interfejs API przetwarzania .NET PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Niezależność od platformy" description="Biblioteka w pełni obsługuje aplikacje C++ opracowane na platformie Windows i Linux posiadające [wymagania systemowe](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Interfejsy API manipulacji PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Aspose.PUB dla C++ obsługuje Publisher [format pliku](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Zaawansowane funkcje API manipulacji C++ PUB
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Konwertuj dokumenty PUB na PDF
    </p>
   </div>
   <!--
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Biblioteka Aspose.PUB dla C++ może odczytywać i konwertować dokumenty publikacji (.pub) do formatu PDF za pomocą zaledwie kilku linijek kodu.
    </p>
...
{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.PUB dla C++?" tabId="success-stories" >}}
