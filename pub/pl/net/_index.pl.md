---
title: Interfejs API do manipulacji plikami C# .NET PUB
weight: 20
url: /pl/net/ 
description: C# ASP.NET VB.NET Publisher API do analizowania, przetwarzania i konwertowania plików MS Publisher. Konwertuj PUB na PDF, Word, Excel i obrazy.
metakeywords: C# dla PUB, Csharp dla PUB, C# PUb, pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Interfejsy API .NET do manipulowania plikami wydawcy" h2="Konwertuj format PUB Publisher na PDF bez żadnych zależności programowych." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
MS Publisher to program do tworzenia dokumentów, które koncentrują się na pracy z informacjami o układzie strony. Program otwiera kolejne formaty plików MS Publisher 2.0 lub nowsze, pliki z rozszerzeniem .txt, pliki RTF, pliki MS Word, pliki HTML, tekst Unicode i wiele innych. To oprogramowanie umożliwia tworzenie własnych zaprojektowanych dokumentów lub używanie sformatowanych projektów dla twojego dokumentu.
MS Publisher zapisuje pliki z rozszerzeniem .pub i niewiele aplikacji poza Publisher może je przetwarzać. 
</p>
<p>
Aspose.PUB for .NET to elastyczna i łatwa w użyciu biblioteka do pracy z plikami publikacji elektronicznych. Obsługuje ładowanie i konwersję popularnego formatu plików publikacji elektronicznych (.pub) do formatu PDF. Oferuje szybką i niezawodną konwersję PUB do PDF, HTML, XLSX, DOC i najpopularniejszych formatów graficznych. Funkcjonalność jest również zaimplementowana w darmowych aplikacjach wieloplatformowych, więc możesz wypróbować ją już teraz.
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="W skrócie" description="Omówienie Aspose.PUB dla .NET API." >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Interfejs API przetwarzania .NET PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Niezależność od platformy" description="Aspose.PUB for .NET obsługuje wszystkie główne platformy, w tym." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Interfejsy API manipulacji PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Aspose.PUB for .NET obsługuje Publisher [format pliku](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Zaawansowane funkcje interfejsu API manipulacji .NET PUB
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Eksportuj pliki PUB do PDF
    </h2>
    <p>
     Aspose.PUB for .NET może odczytywać i konwertować pliki publikacji (.pub) do pliku PDF za pomocą zaledwie kilku linijek kodu.
    </p>
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/pub/net/" >}}
{{< blocks/products/pf/slr-element name="Kod źródłowy" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referencje API" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.PUB dla .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB oferuje indywidualne interfejsy API przetwarzania PUB dla innych popularnych środowisk programistycznych wymienionych poniżej:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/pl/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
    {{< blocks/products/pf/offers-section-item link="/pub/pl/cpp/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg" sdkName="C++" >}}
