---
title: C# .NET PUB file Manipulation API
weight: 20
url: /id/net/ 
description: C# ASP.NET VB.NET Publisher API untuk mengurai, memproses, dan mengonversi file MS Publisher. Konversi PUB ke PDF, Word, Excel, dan gambar.
metakeywords: C# untuk PUB, Csharp untuk PUB, C# PUb, pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API untuk Memanipulasi File Publisher" h2="Konversi format Penerbit PUB ke PDF tanpa ketergantungan perangkat lunak apa pun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
Aspose.PUB untuk .NET adalah perpustakaan yang fleksibel dan mudah digunakan untuk bekerja dengan file publikasi elektronik. Ini mendukung pemuatan dan konversi format file publikasi elektronik populer (.pub) ke PDF. Menawarkan konversi cepat dan andal dari PUB ke PDF, HTML, XLSX, DOC, dan format gambar paling populer. Fungsionalitas ini juga diimplementasikan dalam aplikasi lintas platform gratis sehingga Anda dapat mencobanya sendiri sekarang.
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="Sekilas" description="Ikhtisar Aspose.PUB untuk .NET API." >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET PUB Pemrosesan API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Aspose.PUB untuk .NET mendukung semua platform utama termasuk." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API Manipulasi PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.PUB untuk .NET mendukung Penerbit [format berkas](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fitur API Manipulasi .NET PUB Tingkat Lanjut
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB untuk .NET dapat membaca dan mengonversi file publikasi (.pub) ke file PDF , hanya dengan beberapa baris kode.
    </p>
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/pub/net/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Referensi API" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.PUB untuk .NET?" tabId="success-stories" >}}
