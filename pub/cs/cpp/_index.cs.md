---
title: Publisher Files Parsing API pro C++
weight: 50
url: /cs/cpp/ 
description: Řešení API pro manipulaci se soubory PUB. Knihovna C++ pro analýzu, zpracování a převod formátů dokumentů MS Publisher do PDF. 
metakeywords: Java pro c++, cpp PUB řešení, Java cpp, pub c++ knihovna
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ API pro analýzu souborů vydavatele" h2="Manipulujte se soubory Publisher a také převádějte formát PUB do PDF v jakékoli aplikaci založené na C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
 Aspose.PUB pro C++ je knihovna pro zpracování formátů Microsoft PUb. Umožňuje vývojářům číst a načítat soubory PUB, manipulovat s metadaty a také převádět formát souboru elektronické publikace (.pub) do PDF. Nabízí rychlý a spolehlivý převod PUB do PDF, HTML, XLSX, DOC a nejoblíbenějších obrazových formátů. Funkce je také implementována v bezplatných multiplatformních aplikacích, takže si ji můžete vyzkoušet sami hned teď.
</p>
...
{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Přehled Aspose.PUB pro C++ API." >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Knihovna plně podporuje C++ aplikace vyvinuté na platformách Windows a Linux [Požadavky na systém](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB Manipulation API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.PUB pro C++ podporuje Publisher [formát souboru](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Knihovna Aspose.PUB pro C++ dokáže číst a převádět publikační dokumenty (.pub) do formátu PDF pomocí několika řádků kódu.
    </p>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.PUB pro C++?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB nabízí individuální rozhraní API pro zpracování PUB pro další populární vývojová prostředí, jak je uvedeno níže:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/cs/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
