...
weight: 50
url: /hu/cpp/ 
description: PUB fájlok manipulációs API megoldás. C++ könyvtár az MS Publisher dokumentumformátumok elemzéséhez, feldolgozásához és PDF-be konvertálásához. 
metakeywords: Java for c++, cpp PUB megoldás, Java cpp, pub c++ könyvtár
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ API a Publisher fájlok elemzéséhez" h2="Manipulálhatja a Publisher fájlokat, valamint konvertálhat PUB formátumot PDF-be bármely C++ alapú alkalmazásban." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
 Az Aspose.PUB for C++ egy Microsoft PUb formátumokat feldolgozó könyvtár. Lehetővé teszi a fejlesztők számára a PUB-fájlok olvasását és betöltését, a metaadatok kezelését, valamint az elektronikus publikációs fájlformátum (.pub) PDF-be konvertálását. Gyors és megbízható PUB konvertálást kínál PDF, HTML, XLSX, DOC és a legnépszerűbb képformátumokká. A funkcionalitást ingyenes, többplatformos alkalmazásokban is megvalósítják, így Ön most azonnal kipróbálhatja.
</p>
...
{{< blocks/products/pf/carousel-item h3="Ránézésre" description="Az Aspose.PUB áttekintése C++ API-hoz." >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="A könyvtár teljes mértékben támogatja a Windows és Linux platformon fejlesztett C++ alkalmazásokat [rendszerkövetelmények](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB-manipulációs API-k" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.PUB for C++ támogatja a Publisher alkalmazást [fájlformátum](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     PUB dokumentumok konvertálása PDF-be
    </p>
   </div>
   <!--
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Az Aspose.PUB for C++ könyvtár néhány sornyi kóddal elolvashatja és PDF formátumba konvertálja a publikációs dokumentumokat (.pub).
    </p>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="API referenciák" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.PUB C++-hoz?" tabId="success-stories" >}}
