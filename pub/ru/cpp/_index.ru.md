---
title: API анализа файлов издателя для C++
weight: 50
url: /ru/cpp/ 
description: API-решение для работы с PUB-файлами. Библиотека C++ для анализа, обработки и преобразования форматов документов MS Publisher в PDF. 
metakeywords: Java для c++, решение cpp PUB, Java cpp, библиотека pub c++
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ API для разбора файлов издателя" h2="Управляйте файлами Publisher, а также конвертируйте формат PUB в PDF в любом приложении на основе C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
{{< blocks/products/pf/carousel-item h3="С одного взгляда" description="Обзор Aspose.PUB для C++ API." >}}
...
<li>Преобразование</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API обработки .NET PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Библиотека полностью поддерживает приложения C++, разработанные на платформах Windows и Linux. [Системные Требования](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API управления PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.PUB для C++ поддерживает Publisher [формат файла](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Библиотека Aspose.PUB для C++ может читать и преобразовывать документы публикации (.pub) в формат PDF всего несколькими строками кода..
    </p>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="Ссылки на API" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.PUB для C++?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB предлагает отдельные API-интерфейсы обработки PUB для других популярных сред разработки, перечисленных ниже:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/ru/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
