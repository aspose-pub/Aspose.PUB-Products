...
<p>
 Aspose.PUB for Java는 전자 출판 파일 작업을 위해 유연하고 사용하기 쉬운 라이브러리입니다. 널리 사용되는 전자 출판 파일 형식(.pub)을 PDF로 로드 및 변환하는 기능을 지원합니다. PUB를 PDF, HTML, XLSX, DOC 및 가장 널리 사용되는 이미지 형식으로 빠르고 안정적으로 변환할 수 있습니다. 이 기능은 무료 크로스 플랫폼 애플리케이션에서도 구현되므로 지금 직접 사용해 볼 수 있습니다.
</p>
...
{{< blocks/products/pf/carousel-item h3="한눈에" description="Java API용 Aspose.PUB 개요." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <!--<header><i class="fa fa-bars"> </i>특징</header>
...
<li>변환</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="자바 PUB 처리 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="Aspose.PUB for Java API는 GUI 기반 데스크탑, 웹 및 콘솔 애플리케이션을 완벽하게 지원합니다." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB 조작 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Java용 Aspose.PUB는 게시자를 지원합니다. [파일 형식](https://docs.aspose.com/pub/java/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="자바 PUB API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
<h2 class="h2title">Latest PUB API 특징</h2>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Java용 Aspose.PUB는 몇 줄의 코드만으로 출판 파일(.pub)을 읽고 PDF 파일로 변환할 수 있습니다.
    </p>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/pub/java/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-pub/Aspose.PUB-for-Java" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://reference.aspose.com/pub/java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="왜 자바용 Aspose.PUB인가?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB는 아래 나열된 다른 인기 있는 개발 환경을 위한 개별 PUB 처리 API를 제공합니다." >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/ko/cpp/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg" sdkName="C++" >}}
