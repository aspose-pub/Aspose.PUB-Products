---
title: C# .NET PUB 파일 조작 API
weight: 20
url: /ko/net/ 
description: C# ASP.NET VB.NET Publisher API는 MS Publisher 파일을 구문 분석, 처리 및 변환합니다. PUB를 PDF, Word, Excel 및 이미지로 변환.
metakeywords: PUB용 C#, PUB용 Csharp, C# PUb, pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="게시자 파일을 조작하는 .NET API" h2="소프트웨어 종속성 없이 PUB Publisher 형식을 PDF로 변환." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
.NET용 Aspose.PUB는 전자 출판 파일 작업을 위한 유연하고 사용하기 쉬운 라이브러리입니다. 널리 사용되는 전자 출판 파일 형식(.pub)을 PDF로 로드 및 변환하는 기능을 지원합니다. PUB를 PDF, HTML, XLSX, DOC 및 가장 널리 사용되는 이미지 형식으로 빠르고 안정적으로 변환할 수 있습니다. 이 기능은 무료 크로스 플랫폼 애플리케이션에서도 구현되므로 지금 직접 사용해 볼 수 있습니다.
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="한눈에" description=".NET API용 Aspose.PUB 개요." >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET PUB 처리 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description=".NET용 Aspose.PUB는 다음을 포함한 모든 주요 플랫폼을 지원합니다.." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB 조작 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description=".NET용 Aspose.PUB는 게시자를 지원합니다. [파일 형식](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     .NET용 Aspose.PUB는 단 몇 줄의 코드로 출판 파일(.pub)을 읽고 PDF 파일로 변환할 수 있습니다..
    </p>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/pub/net/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="왜 .NET용 Aspose.PUB인가?" tabId="success-stories" >}}
