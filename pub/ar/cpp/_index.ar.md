...
weight: 50
url: /ar/cpp/ 
description: حل API لمعالجة ملفات PUB. مكتبة C++ لتحليل ومعالجة وتحويل تنسيقات مستندات MS Publisher إلى PDF. 
metakeywords: Java لـ c ++ ، حل cpp PUB ، Java cpp ، مكتبة Pub c ++
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ API لتحليل ملفات الناشر" h2="معالجة ملفات Publisher وكذلك تحويل تنسيق PUB إلى PDF داخل أي تطبيق قائم على C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
يحفظ MS Publisher الملفات بامتداد .pub ولا يمكن للعديد من التطبيقات بخلاف Publisher معالجة مثل هذه الملفات. 
</p>
<p>
 Aspose.PUB for C++ هي مكتبة معالجة تنسيقات Microsoft PUb. يسمح للمطورين بقراءة وتحميل ملفات PUB ، ومعالجة البيانات الوصفية وكذلك تحويل تنسيق ملف النشر الإلكتروني (.pub) إلى PDF. يوفر تحويلًا سريعًا وموثوقًا لـ PUB إلى PDF و HTML و XLSX و DOC وتنسيقات الصور الأكثر شيوعًا. يتم تنفيذ الوظيفة أيضًا في تطبيقات مجانية عبر الأنظمة الأساسية حتى تتمكن من تجربتها بنفسك الآن.
</p>
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="نظرة عامة على Aspose.PUB لواجهة برمجة تطبيقات C++." >}}
...
{{< blocks/products/pf/carousel-item h3="منصة الاستقلال" description="تدعم المكتبة بشكل كامل تطبيقات C++ المطورة على نظامي التشغيل Windows و Linux [متطلبات النظام](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="واجهات برمجة تطبيقات معالجة PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="تنسيقات الملفات المدعومة" description="Aspose.PUB لـ C++ يدعم Publisher [تنسيق الملف](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     تحويل ملفات PUB إلى PDF
    </h2>
    <p>
     يمكن لمكتبة Aspose.PUB لـ C++ قراءة وتحويل مستندات النشر (.pub) إلى تنسيق PDF ، مع بضعة أسطر من التعليمات البرمجية.
    </p>
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="مصدر الرمز" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="مراجع API" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.PUB لـ C++؟" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="يقدم Aspose.PUB واجهات برمجة تطبيقات معالجة PUB فردية لبيئات التطوير الشائعة الأخرى كما هو موضح أدناه:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/ar/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
