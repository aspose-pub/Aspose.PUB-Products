---
title: الناشر ملفات تحليل API لجافا
weight: 40
url: /ar/java/ 
description: مكتبة Java لتحليل ومعالجة وتحويل تنسيقات مستندات Publisher إلى PDF. قم بتنفيذ الوظيفة في منتجك الخاص.
metakeywords: Java لـ PUB ، حل Java PUB ، Java PUb ، مكتبة Java Pub
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="واجهات برمجة تطبيقات معالجة ملفات Java PUB" h2="قم بتحميل وتحويل PUB إلى PDF داخل التطبيقات المستندة إلى Java دون أي تبعيات للبرامج." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-java.svg" pfName="Aspose.PUB " subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/pub/java" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PUB " subTitlepfName="for Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/pub/java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/pub/java/" installationsDocsLink="https://docs.aspose.com/pub/java/installation/" nugetLink="" nugetPackageName="الناشر:" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-pub" directDownloadLink="https://downloads.aspose.com/pub/java" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
MS Publisher هو برنامج لإنشاء مستندات تركز على العمل مع معلومات تخطيط الصفحة. يفتح البرنامج تنسيقات الملفات التالية MS Publisher 2.0 أو أحدث ، وملفات بامتداد .txt ، وملفات RTF ، وملفات MS Word ، وملفات HTML ، ونص Unicode ، وغيرها الكثير. يسمح هذا البرنامج بإنشاء المستندات المصممة الخاصة بك أو استخدام التصميمات المهيأة للمستند الخاص بك.
يحفظ MS Publisher الملفات بامتداد .pub ولا يمكن للعديد من التطبيقات باستثناء Publisher معالجة مثل هذه الملفات. 
</p>
<p>
 Aspose.PUB for Java مكتبة مرنة وسهلة الاستخدام للعمل مع ملفات النشر الإلكترونية. وهو يدعم تحميل وتحويل تنسيق ملف النشر الإلكتروني الشهير (.pub) إلى PDF. يوفر تحويلًا سريعًا وموثوقًا لـ PUB إلى PDF و HTML و XLSX و DOC وتنسيقات الصور الأكثر شيوعًا. يتم تنفيذ الوظيفة أيضًا في تطبيقات مجانية عبر الأنظمة الأساسية حتى تتمكن من تجربتها بنفسك الآن.
</p>
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="نظرة عامة على Aspose.PUB for Java API." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <!--<header><i class="fa fa-bars"> </i>سمات</header>
...
<li>تحويلات</li>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     العمل مع البيانات الوصفية لملفات PUB
    </li>
   </ul>
  </div>
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="منصة الاستقلال" description="Aspose.PUB for Java API يدعم بشكل كامل تطبيقات سطح المكتب والويب ووحدة التحكم القائمة على واجهة المستخدم الرسومية." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="واجهات برمجة تطبيقات معالجة PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="تنسيقات الملفات المدعومة" description="يدعم Aspose.PUB لجافا الناشر [تنسيق الملف](https://docs.aspose.com/pub/java/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    ميزات واجهة برمجة تطبيقات معالجة Java PUB المتقدمة
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<h2 class="h2title">Latest PUB API سمات</h2>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     مستندات PUB إلى تحويل PDF
    </h2>
    <p>
     يمكن لـ Aspose.PUB for Java قراءة وتحويل ملفات النشر (.pub) إلى ملف PDF ، ببضعة سطور فقط من التعليمات البرمجية.
    </p>
    <div class="codeblock" id="code">
     <h3>
      تحويل PUB إلى PDF - Java
     </h3>
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/pub/java/" >}}
{{< blocks/products/pf/slr-element name="مصدر الرمز" href="https://github.com/aspose-pub/Aspose.PUB-for-Java" >}}
{{< blocks/products/pf/slr-element name="مراجع API" href="https://apireference.aspose.com/pub/java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.PUB لجافا؟" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="يقدم Aspose.PUB واجهات برمجة تطبيقات معالجة PUB فردية لبيئات التطوير الشائعة الأخرى كما هو موضح أدناه:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/ar/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg" sdkName=".NET" >}}
    {{< blocks/products/pf/offers-section-item link="/pub/ar/cpp/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg" sdkName="C++" >}}
