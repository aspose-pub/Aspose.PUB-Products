...
weight: 20
url: /ar/net/ 
description: C# ASP.NET VB.NET Publisher API لتحليل ومعالجة وتحويل ملفات MS Publisher. قم بتحويل PUB إلى PDF و Word و Excel والصور.
metakeywords: C# لـ PUB و Csharp لـ PUB و C# PUb و pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="NET APIs لمعالجة ملفات الناشر" h2="قم بتحويل تنسيق PUB Publisher إلى PDF بدون أي تبعيات للبرامج." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
Aspose.PUB for .NET مكتبة مرنة وسهلة الاستخدام للعمل مع ملفات النشر الإلكترونية. وهو يدعم تحميل وتحويل تنسيق ملف النشر الإلكتروني الشهير (.pub) إلى PDF. يوفر تحويلًا سريعًا وموثوقًا لـ PUB إلى PDF و HTML و XLSX و DOC وتنسيقات الصور الأكثر شيوعًا. يتم تنفيذ الوظيفة أيضًا في تطبيقات مجانية عبر الأنظمة الأساسية حتى تتمكن من تجربتها بنفسك الآن.
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="نظرة عامة على Aspose.PUB لـ .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="منصة الاستقلال" description="يدعم Aspose.PUB for .NET جميع المنصات الرئيسية بما في ذلك." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="واجهات برمجة تطبيقات معالجة PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="تنسيقات الملفات المدعومة" description="يدعم Aspose.PUB for .NET الناشر [تنسيق الملف](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    ميزات واجهة برمجة تطبيقات معالجة NET PUB المتقدمة
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     يمكن لـ Aspose.PUB for .NET قراءة وتحويل ملفات النشر (.pub) إلى ملف PDF ، ببضعة سطور فقط من التعليمات البرمجية.
    </p>
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/pub/net/" >}}
{{< blocks/products/pf/slr-element name="مصدر الرمز" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="مراجع API" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.PUB لـ .NET؟" tabId="success-stories" >}}
