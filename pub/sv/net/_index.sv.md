---
title: C# .NET PUB-filer Manipulation API
weight: 20
url: /sv/net/ 
description: C# ASP.NET VB.NET Publisher API för att analysera, bearbeta och konvertera MS Publisher-filer. Konvertera PUB till PDF, Word, Excel och bilder.
metakeywords: C# för PUB, Csharp för PUB, C# PUb, pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API:er för att manipulera utgivarfiler" h2="Konvertera PUB Publisher-format till PDF utan några programberoenden." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över Aspose.PUB för .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.PUB för .NET stöder alla större plattformar inklusive." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB Manipulation API:er" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.PUB för .NET stöder Publisher [filformat](https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Redigera metadata för PUB-filer
    </p>
   </div>
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API-referenser" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.PUB för .NET?" tabId="success-stories" >}}
