---
title: Java 的发布者文件解析 API
weight: 40
url: /zh/java/ 
description: 用于解析、处理和将 Publisher 文档格式转换为 PDF 的 Java 库。将功能实现到您自己的产品中.
metakeywords: Java for PUB, Java PUB 解决方案, Java PUb, pub Java 库
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java PUB 文件操作 API" h2="在基于 Java 的应用程序中加载和转换 PUB 为 PDF，无需任何软件依赖." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-java.svg" pfName="Aspose.PUB " subTitlepfName="for Java" downloadUrl="https://releases.aspose.com/pub/java//" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
 Aspose.PUB for Java 是一个灵活且易于使用的库来处理电子出版物文件。它支持将流行的电子出版物文件格式 (.pub) 加载和转换为 PDF。它提供 PUB 到 PDF、HTML、XLSX、DOC 和最流行的图像格式的快速可靠的转换。该功能还在免费的跨平台应用程序中实现，因此您现在可以自己尝试。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.PUB for Java API 概述." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <!--<header><i class="fa fa-bars"> </i>特征</header>
...
<li>转换</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java PUB 处理 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.PUB for Java API 完全支持基于 GUI 的桌面、Web 和控制台应用程序。" >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB 操作 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.PUB for Java 支持 Publisher [文件格式](https://docs.aspose.com/pub/java/supported-file-formats/)." >}}
...
<h2 class="h2title">Latest PUB API 特征</h2>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for Java 可以读取发布文件 (.pub) 并将其转换为 PDF 文件，只需几行代码。
    </p>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/pub/java/" >}}
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-pub/Aspose.PUB-for-Java" >}}
{{< blocks/products/pf/slr-element name="API 参考" href="https://reference.aspose.com/pub/java/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 Aspose.PUB for Java？" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB 为其他流行的开发环境提供单独的 PUB 处理 API，如下所示：" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/zh/cpp/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg" sdkName="C++" >}}
