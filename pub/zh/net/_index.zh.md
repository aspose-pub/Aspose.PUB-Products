...
weight: 20
url: /zh/net/ 
description: C# ASP.NET VB.NET Publisher API 用于解析、处理和转换 MS Publisher 文件。将 PUB 转换为 PDF、Word、Excel 和图像.
metakeywords: 用于 PUB 的 C#、用于 PUB 的 Csharp、C# PUB、pub .NET
---
...
<p>
Aspose.PUB for .NET 是一个灵活且易于使用的库，用于处理电子出版物文件。它支持将流行的电子出版物文件格式 (.pub) 加载和转换为 PDF。它提供 PUB 到 PDF、HTML、XLSX、DOC 和最流行的图像格式的快速可靠的转换。该功能还在免费的跨平台应用程序中实现，因此您现在可以自己尝试。
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET PUB 处理 API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.PUB for .NET 支持所有主要平台，包括." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for .NET 可以读取发布文件 (.pub) 并将其转换为 PDF 文件，只需几行代码.
    </p>
...
{{< blocks/products/pf/slr-tab tabTitle="为什么 Aspose.PUB 用于 .NET？" tabId="success-stories" >}}
