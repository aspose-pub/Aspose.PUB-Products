...
item1: Φόρτωση αρχείου PUB χρησιμοποιώντας [*CreateParser*()](https://apireference.aspose.com/pub/net/aspose.pub/pubfactory/methods/createparser/index) Μέθοδος [*PubFactory*](https://apireference.aspose.com/pub/net/aspose.pub/pubfactory) Τάξη.
item2: Ανάλυση αρχείου μέσω [*Parse*()](https://apireference.aspose.com/pub/net/aspose.pub/ipubparser/methods/parse) Μέθοδος του [*IPubParser*](https://apireference.aspose.com/pub/net/aspose.pub/ipubparser) Διεπαφή.
item3: Μετατροπή PUB σε PDF μέσω [*ConvertToPdf*()](https://apireference.aspose.com/pub/net/aspose.pub/ipdfconverter/methods/converttopdf) Μέθοδος [*IPdfConverter*](https://apireference.aspose.com/pub/net/aspose.pub/ipdfconverter) Διεπαφή.
---
...
item2: Εναλλακτικά, αποκτήστε το πρόγραμμα εγκατάστασης MSI εκτός σύνδεσης ή τα DLL σε ένα αρχείο ZIP από το [downloads](https://downloads.aspose.com/pub/net).
---
