---
title: API phân tích cú pháp tệp của nhà xuất bản dành cho Java
weight: 40
url: /vi/java/ 
description: Thư viện Java để phân tích cú pháp, xử lý và chuyển đổi các định dạng tài liệu Publisher sang PDF. Triển khai chức năng vào sản phẩm của riêng bạn.
metakeywords: Java cho PUB, giải pháp Java PUB, Java PUb, thư viện pub Java
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API thao tác tệp Java PUB" h2="Tải và chuyển đổi PUB sang PDF trong các ứng dụng dựa trên Java mà không cần bất kỳ phụ thuộc phần mềm nào." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-java.svg" pfName="Aspose.PUB " subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/pub/java" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PUB " subTitlepfName="for Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/pub/java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/pub/java/" installationsDocsLink="https://docs.aspose.com/pub/java/installation/" nugetLink="" nugetPackageName="Nhà xuất bản:" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-pub" directDownloadLink="https://downloads.aspose.com/pub/java" >}}
...
MS Publisher lưu các tệp với phần mở rộng .pub và không nhiều ứng dụng ngoài Publisher có thể xử lý các tệp như vậy. 
</p>
<p>
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về Aspose.PUB cho Java API." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <!--<header><i class="fa fa-bars"> </i>Đặc trưng</header>
...
<li>Chuyển đổi</li>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Làm việc với Siêu dữ liệu của tệp PUB
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API xử lý Java PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="API Aspose.PUB cho Java hỗ trợ đầy đủ các Ứng dụng Máy tính để bàn, Web và Bảng điều khiển dựa trên GUI." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API thao tác PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="Aspose.PUB cho Java hỗ trợ Publisher [định dạng tệp](https://docs.aspose.com/pub/java/supported-file-formats/)." >}}
...
<h2 class="h2title">Latest PUB API Đặc trưng</h2>
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/pub/java/" >}}
{{< blocks/products/pf/slr-element name="Mã nguồn" href="https://github.com/aspose-pub/Aspose.PUB-for-Java" >}}
{{< blocks/products/pf/slr-element name="Tham chiếu API" href="https://apireference.aspose.com/pub/java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao nên dùng Aspose.PUB cho Java?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUB cung cấp các API xử lý PUB riêng lẻ cho các môi trường phát triển phổ biến khác như được liệt kê bên dưới:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/vi/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg" sdkName=".NET" >}}
