---
title: API phân tích cú pháp tệp của nhà xuất bản cho C++
weight: 50
url: /vi/cpp/ 
description: Giải pháp API thao tác tệp PUB. Thư viện C++ để phân tích cú pháp, xử lý và chuyển đổi các định dạng tài liệu MS Publisher sang PDF. 
metakeywords: Java cho c ++, giải pháp cpp PUB, Java cpp, thư viện pub c ++
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API C++ để phân tích cú pháp tệp nhà xuất bản" h2="Thao tác với tệp Publisher cũng như Chuyển đổi định dạng PUB sang PDF trong bất kỳ ứng dụng dựa trên C++ nào." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về Aspose.PUB cho API C++." >}}
...
<li>Chuyển đổi</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API xử lý .NET PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Thư viện hỗ trợ đầy đủ các ứng dụng C++ được phát triển trên nền tảng Windows và Linux có [yêu cầu hệ thống](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API thao tác PUB" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="Aspose.PUB cho C++ hỗ trợ Publisher [định dạng tệp](https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="Mã nguồn" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="Tham chiếu API" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao Aspose.PUB cho C++?" tabId="success-stories" >}}
