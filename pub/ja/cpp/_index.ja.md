---
title: C++用のPublisherファイル解析API
weight: 50
url: /ja/cpp/ 
description: PUBファイル操作APIソリューション。 MS Publisherのドキュメント形式を解析、処理、PDFに変換するC++ライブラリ. 
metakeywords: Java for c ++、cpp PUBソリューション、Java cpp、pubc++ライブラリ
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="パブリッシャーファイルを解析するためのC++API" h2="C++ベースのアプリケーション内で、パブリッシャーファイルを操作し、PUB形式をPDFに変換します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-cpp.svg" pfName="Aspose.PUB " subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/pub/cpp" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
{{< blocks/products/pf/carousel-item h3="一目で" description="Aspose.PUB for C++APIの概要。" >}}
...
<li>変換</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NETPUB処理API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="ライブラリは、WindowsおよびLinuxプラットフォームで開発されたC++アプリケーションを完全にサポートしています。 [システム要求](https://docs.aspose.com/pub/net/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB操作API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Aspose.PUB forC++はPublisherをサポートしています 【ファイル形式】(https://docs.aspose.com/pub/cpp/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/pub/cpp/" >}}
{{< blocks/products/pf/slr-element name="ソースコード" href="https://github.com/aspose-pub/Aspose.PUB-for-C" >}}
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://apireference.aspose.com/pub/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="なぜC++用のAspose.PUBなのですか？" tabId="success-stories" >}}
