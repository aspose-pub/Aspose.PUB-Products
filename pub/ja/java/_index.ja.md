---
title: Java用のPublisherファイル解析API
weight: 40
url: /ja/java/ 
description: Publisherドキュメント形式を解析、処理、PDFに変換するJavaライブラリ。独自の製品に機能を実装する.
metakeywords: Java for PUB、Java PUBソリューション、Java PUb、pubJavaライブラリ
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaPUBファイル操作API" h2="ソフトウェアに依存せずにJavaベースのアプリケーション内でPUBをロードしてPDFに変換する." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-java.svg" pfName="Aspose.PUB " subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/pub/java" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PUB " subTitlepfName="for Java" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/pub/java" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/pub/java/" installationsDocsLink="https://docs.aspose.com/pub/java/installation/" nugetLink="" nugetPackageName="出版社：" mavenRepoLink="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-pub" directDownloadLink="https://downloads.aspose.com/pub/java" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
MS Publisherは、ページレイアウト情報の操作に焦点を合わせたドキュメントを作成するためのプログラムです。プログラムは、MS Publisher 2.0以降、拡張子が.txtのファイル、RTFファイル、MS Wordファイル、HTMLファイル、Unicodeテキストなどの次のファイル形式を開きます。このソフトウェアを使用すると、独自のデザインドキュメントを作成したり、ドキュメントにフォーマットされたデザインを使用したりできます。
MS Publisherは、拡張子が.pubのファイルを保存しますが、Publisher以外の多くのアプリケーションがそのようなファイルを処理できるわけではありません。 
</p>
<p>
 Aspose.PUB for Javaは、電子パブリケーションファイルを操作するための柔軟で使いやすいライブラリです。一般的な電子出版ファイル形式（.pub）のPDFへのロードと変換をサポートします。 PUBからPDF、HTML、XLSX、DOC、および最も一般的な画像形式への迅速で信頼性の高い変換を提供します。この機能は無料のクロスプラットフォームアプリケーションにも実装されているため、今すぐ試すことができます。
</p>
...
{{< blocks/products/pf/carousel-item h3="一目で" description="Aspose.PUB forJavaAPIの概要." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <!--<header><i class="fa fa-bars"> </i>特徴</header>
...
<li>変換</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JavaPUB処理API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.PUB for Java APIは、GUIベースのデスクトップ、Web、およびコンソールアプリケーションを完全にサポートします。" >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB操作API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Aspose.PUBforJavaはPublisherをサポートしています 【ファイル形式】(https://docs.aspose.com/pub/java/supported-file-formats/)." >}}
...
<h2 class="h2title">Latest PUB API 特徴</h2>
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for Javaは、わずか数行のコードで、パブリケーションファイル（.pub）を読み取ってPDFファイルに変換できます。
    </p>
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/pub/java/" >}}
{{< blocks/products/pf/slr-element name="ソースコード" href="https://github.com/aspose-pub/Aspose.PUB-for-Java" >}}
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://apireference.aspose.com/pub/java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.PUB forJavaを選ぶ理由" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUBは、以下に示すように、他の一般的な開発環境向けに個別のPUB処理APIを提供します。" >}}

    {{< blocks/products/pf/offers-section-item link="/pub/ja/net/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg" sdkName=".NET" >}}
    {{< blocks/products/pf/offers-section-item link="/pub/ja/cpp/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-cpp.svg" sdkName="C++" >}}
