---
title: C＃.NETPUBファイル操作API
weight: 20
url: /ja/net/ 
description: C＃ASP.NET VB.NET Publisher APIは、MS Publisherファイルを解析、処理、および変換します。 PUBをPDF、Word、Excel、および画像に変換します.
metakeywords: PUBの場合はC＃、PUBの場合はCsharp、C＃PUb、pub .NET
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="パブリッシャーファイルを操作するための.NETAPI" h2="ソフトウェアに依存せずにPUBPublisher形式をPDFに変換する." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/headers/aspose_pub-for-net.svg" pfName="Aspose.PUB " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/pub/net" tryOnlineUrl="https://products.aspose.app/pub/applications" >}}
...
<p>
Aspose.PUB for .NETは、電子パブリケーションファイルを操作するための柔軟で使いやすいライブラリです。一般的な電子出版ファイル形式（.pub）のPDFへのロードと変換をサポートします。 PUBからPDF、HTML、XLSX、DOC、および最も一般的な画像形式への迅速で信頼性の高い変換を提供します。この機能は無料のクロスプラットフォームアプリケーションにも実装されているため、今すぐ試すことができます。
</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
{{< blocks/products/pf/carousel-item h3="一目で" description="Aspose.PUB for.NETAPIの概要。" >}}
...
<li>Conversion</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NETPUB処理API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.PUB for .NETは、以下を含むすべての主要なプラットフォームをサポートします." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PUB操作API" src="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-net.svg"/>
  <header>
   Aspose.PUB
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Aspose.PUBfor.NETはPublisherをサポートしています 【ファイル形式】(https://docs.aspose.com/pub/net/supported-file-formats/)." >}}
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PUB for .NETは、わずか数行のコードで、パブリケーションファイル（.pub）を読み取ってPDFファイルに変換できます。.
    </p>
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/pub/net/" >}}
{{< blocks/products/pf/slr-element name="ソースコード" href="https://github.com/aspose-pub/Aspose.PUB-for-.NET" >}}
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://apireference.aspose.com/net/pub" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.PUB for.NETを選ぶ理由" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.PUB" description="Aspose.PUBは、以下に示すように、他の一般的な開発環境向けに個別のPUB処理APIを提供します。" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/pub/ja/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/pub/aspose_pub-for-java.svg" sdkName="Java" >}}
